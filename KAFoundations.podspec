#
#  Be sure to run `pod spec lint KAFoundations.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = 'KAFoundations'
  s.version      = '0.0.1'
  s.summary      = 'KAFoundations provide components to expedite app production'
